...
const Sidebar = () => {
  ...
  // Efficiently filter users with useMemo
      ...
      <div className="border-b border-base-300 w-full p-5">
        ...
        <div className="mt-3">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/40 size-4 hidden lg:block" />
            <input
              type="text"
              ...
              className="w-full lg:pl-10 pl-3 pr-10 py-2 text-sm bg-base-200 border border-base-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              autoComplete="off"
              spellCheck="false"
            />
            {searchQuery && (
